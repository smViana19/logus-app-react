...
export default function EventModal() {
  ...
  return (
    <div className="h-screen w-full fixed left-0 top-0 flex justify-center items-center">
      <form className="bg-white rounded-lg shadow-2xl xl:w-1/4 lg:w-1/2 sm:w-2/3 w-full pl-8">
        <header className="bg-zinc-100 px-4 py-2 flex justify-between items-center">
          <span className="material-icons-outlined text-zinc-400">
            drag_handle
          </span>
          <div className="flex items-center gap-4">
            {selectedEvent && (
              <span
                ...
                className="material-icons-outlined text-zinc-400 cursor-pointer"
              >
        ...
        <div className="p-3">
          <div className="grid grid-cols-1/5 items-end gap-y-7">
            ...
            <input
              ...
              value={title}
              required
              className="pt-3 border-0 text-zinc-600 text-xl font-semibold pb-2 w-full border-b-2 border-zinc-200 focus:outline-none focus:ring-0 focus:border-blue-500"
            ...
            <input
              ...
              value={description}
              required
              className="pt-3 border-0 text-zinc-600 pb-2 w-full border-b-2 border-zinc-200 focus:outline-none focus:ring-0 focus:border-blue-500"
