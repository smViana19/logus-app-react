...
const Sidebar = ({ role }) => {
  ...
  return (
    <div className="fixed flex flex-col top-14 left-0 w-14 hover:w-64 md:w-64 bg-white dark:bg-zinc-900 h-full transition-all duration-300 border-none z-10 sidebar overflow-hidden dark:text-gray-300">
      <div className="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
        <ul className="flex flex-col py-4 space-y-1">
          ...
          <div className="border-t border-gray-300 dark:border-gray-600 my-10" />
          {role === 'diretor' &&
