          ...
          <div className="grid gap-2">
            ...
            <div className="flex items-center justify-center">
              <label>
                ...
                <div className="flex py-2 px-8 flex-col bg-purplePrimary rounded-md shadow text-white text-sm items-center justify-center cursor-pointer focus:outline-none">
                  Escolher Arquivo
                </div>
              </label>
            </div>
