...
const BtnGestaoEscolar = ({title, number, description, svg, path}) => {
  return (
    <Link to={path} className="p-6 bg-white rounded-md shadow-md space-y-4 dark:bg-zinc-800 cursor-pointer hover:bg-gray-100 dark:hover:bg-zinc-700 transition-all">
